            ...
            for k, v in d['module'].items():
                ...
                if len(v.shape) == 2 and 'position' not in k:
                    if 'query' in k:
                        ...
                        d_new['module'][k] = torch.cat([v[shift * part:(shift + 1) * part, :],
                    ...
                    d_new['module'][k] = torch.cat(
                        [v[shift * part:(shift + 1) * part], v[(shift + ratio) * part:(shift + 1 + ratio) * part],
                         v[(shift + 2 * ratio) * part:(shift + 1 + 2 * ratio) * part]], 0)
                else:
                    d_new['module'][k] = v
